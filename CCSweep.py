...
parameters_dict = {
    ...
    'seed':{'values':[0]},
    'data_type': {'values': ['PNAS-highcoh_regime_all_seeds']},#PNAS-highcoh_regime_all_seeds,PNAS-regime_all_seeds,PNAS-lowcoh_regime_all_seeds,PNAS-regime_all_seeds
    ...
    'G_0_intiailization':{'values':[False, True]},
