...
#data_path=os.path.join(cwd,'Data/FoldyLox_all_seeds/FoldyLox_seed0')
exp_name=f'FoldyLox seed0 10k data, 2 layer'
...
for EXP_NUM in range(1): #[33, 34, 35, 40, 41] BOTH THESE RUNNING NOW. old machine running 49, 40, 41 in tandem
    ...
    rh_v, _=torch.split(rho_val, 361, dim=-1)
    ...
    decoder_hats=[]
    print(f'indim: {indim}, outdim: {outdim}')
    ...
    #            res.scatter(1, indices, topk)
        ...
        val_lossavg=0
        #if epoch%50==49:
        wand_dict['Training image']=H.plot_2_unordered_imgs(epoch,rho, rho_hat,ind=5, figsize=5, scaling=None, xpix=19, ypix=19, font_size=25)
        encoder.eval()
        decoder.eval()
        ...
        #if epoch%50==49:
        wand_dict['Validation image']=H.plot_2_unordered_imgs(epoch, rho_val, rho_hat,ind=5, figsize=5, scaling=None, xpix=19, ypix=19, font_size=25)
